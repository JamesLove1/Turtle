...
parse_s: Parse/parse.h Parse/parse.c Testing/testing_parse.c
	$(CC) Parse/parse.c Testing/testing_parse.c -o parse_s -I ./Parse $(SANITIZE) -lm

parse_v: Parse/parse.h Parse/parse.c Testing/testing_parse.c
	$(CC) Parse/parse.c Testing/testing_parse.c -o parse_v -I ./Parse $(VALGRIND) -lm

interp_s: Interp/interp.h Interp/interp.c neillsimplescreen.c neillsimplescreen.h Testing/testing_interp.c
	$(CC) neillsimplescreen.c Interp/interp.c Testing/testing_interp.c -o interp_s -I./Interp $(SANITIZE) -lm

interp_v: Interp/interp.h Interp/interp.c neillsimplescreen.c neillsimplescreen.h Testing/testing_interp.c
	$(CC) neillsimplescreen.c Interp/interp.c Testing/testing_interp.c -o interp_v -I./Interp $(VALGRIND) -lm

### An example : you may wish to adapt this slightly
extension_s: Extension/extension.h Extension/extension.c neillsimplescreen.c neillsimplescreen.h Testing/testing_extension.c
	$(CC) neillsimplescreen.c Extension/extension.c Testing/testing_extension.c -o extension_s -I./Extension $(SANITIZE) -lm

run_Parse: Parse/parse.h Parse/parse.c
...
run_Interp: Interp/interp.h Interp/interp.c neillsimplescreen.c neillsimplescreen.h
